...
class Delete_Brand_Ambassador extends StatefulWidget {
  static const String id = 'Delete_Brand_Ambassador';

  @override
  _DeleteState createState() => _DeleteState();
}

class _DeleteState extends State<Delete_Brand_Ambassador> {
